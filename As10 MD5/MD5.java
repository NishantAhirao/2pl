...
public class MD5 {
    ...
    private static final int INIT_B = (int) 0xEFCDAB89L;   //4 chaining variables A B C D
    ...
    public static byte[] computeMD5(byte[] message) {
        ...
        int numBlocks = ((messageLenBytes + 8) >>> 6) + 1; //divide by 64
        
        int totalLen = numBlocks << 6; //multiply by 64
        
        byte[] paddingBytes = new byte[totalLen - messageLenBytes];
        paddingBytes[0] = (byte) 0x80;
        
        long messageLenBits = (long) messageLenBytes << 3; //multiply by 8
